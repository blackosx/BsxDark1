...
- then just add the BsxDark1 directory

Either way, for this theme you will want to end up having
EFI/OC/Resources/Image/Blackosx/BsxDark1

You can switch the icon set used by OpenCanopy by changing the 'PickerVariant' key in OpenCore's config.plist to match the vendor and theme name of the icon set you want to display. So to instruct OpenCanopy to use this icon set you want to set the PickerVariant key to Blackosx\BsxDark1

```
                <key>PickerVariant</key>
                <string>Blackosx\BsxDark1</string>
```
